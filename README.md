crunchbase_processing
==============================

Some basic processing of the CrunchBase data
...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so crunchbase_processing can be imported
    │
    ├── crunchbase_processing                <- Source code for use in this project.
    │   ├── __init__.py    <- Makes crunchbase_processing a Python module
    │   │
